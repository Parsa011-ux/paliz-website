      ...
      <main className="flex-1 w-full py-8 md:py-12">
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <article className="w-full">
            ...
            {/* Title */}
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight text-right">
              {article.title_fa}
            </h1>
            ...
            {article.summary_fa && (
              <div className="mb-8 p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 to-orange-500/5 border border-amber-500/20">
                <p
                  className="text-lg md:text-xl text-neutral-100 font-medium text-right"
                  style={{ lineHeight: "2" }}
                >
                  {article.summary_fa}
                </p>
            ...
            {paragraphs.length > 0 && (
              <div className="w-full mb-10">
                ...
                {paragraphs.map((paragraph, index) => (
                  <p
                    key={index}
                    className="text-base md:text-lg text-neutral-300 mb-6 text-right"
