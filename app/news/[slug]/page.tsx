      ...
      <main className="flex-1 site-container py-8 md:py-12">
        <article className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3 mb-4 flex-wrap">
            ...
            {publishDate && (
              <span className="text-sm text-neutral-500">📅 {publishDate}</span>
            )}
          </div>
          ...
          <div className="flex items-center justify-between flex-wrap gap-3 pb-6 mb-6 border-b border-neutral-800">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-500 to-orange-500 flex items-center justify-center text-white font-bold">
                {article.source_name_fa?.[0] || article.source_name?.[0] || "پ"}
              </div>
              <div>
            ...
            <div className="flex items-center gap-4 text-sm text-neutral-500">
              <span>👁 {article.view_count.toLocaleString("fa-IR")} بازدید</span>
          ...
          <div className="mt-10 p-6 rounded-2xl bg-neutral-900 border border-neutral-800">
            ...
            >
              <span>📖 مشاهده در {article.source_name_fa || article.source_name}</span>
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
